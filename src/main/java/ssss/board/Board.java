...
public class Board {
    ...
    public boolean isHavePieceWithColor(Color color) {
...
//        setPiece(new Coordinates(File.G,1),new Rook(Color.BLACK,new Coordinates(File.G,1)));
        setPiece(new Coordinates(File.G, 2), new Pawn(new Coordinates(File.F, 2), Color.BLACK));
        setPiece(new Coordinates(File.G, 7), new Pawn(new Coordinates(File.G, 7), Color.WHITE));
